...
<div class="row margin-bottom">
	<div class="col-xs-12">
	<a href="{{ action('SalaryUserController@create') }}" class="btn btn-primary">Thêm mới lương cá nhân</a>
	<a href="{{ action('SalaryUserController@createSalaryOldUser') }}" class="btn btn-primary">Đề xuất lương cá nhân</a>
